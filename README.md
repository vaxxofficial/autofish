...
A simple, feature-rich Minecraft mod built for the Fabric loader (version 1.21.11) that automatically casts and reels in your fishing rod. It includes configurable randomization to mimic human behavior, specific enhancements to avoid AFK detection, and support for mythical fish on popular servers like Hypixel Skyblock.
...
- **Mythical Fish Support:** Attempts to automatically fight and catch difficult or "mythical" fish.
